...
const unsigned long durasiBuka = 3000; // 3 detik

byte salahCount = 0;
bool lockout = false;
unsigned long tLockoutMulai = 0;
const unsigned long durasiLockout = 30000; // 30 detik

// Jika tombol '1' di keypad fisik rusak, aktifkan substitusi ini:
// #define SUBSTITUSI_1_D
